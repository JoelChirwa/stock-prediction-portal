      ...
      <div className="row justify-content-center mt-4">
        <div className="col-md-6 bg-light-dark p-4 rounded">
          ...
          <form onSubmit={handleRegistration}>
            ...
            <div className="mb-3">
              <input type="password" placeholder="Set your password" className="form-control" value={password} onChange={(e) => setPassword(e.target.value)} />
              <small className="text-danger">{error.password}</small>
            </div>
            {success && <div className="alert alert-success">Registration successful! You can now <a href="/login">login</a>.</div>}
            {loading ? (
